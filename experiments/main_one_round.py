...
PARAMETERS = {'max_screen_size': [100000],
              'batch_size': [64, 32, 16],
...
if __name__ == '__main__':
    ...
    parser.add_argument('-path_prior', help='The path to folder with train compounds', default='')
    parser.add_argument('-path_select', help='The path to folder with select compounds', default='')
    # parser.add_argument('-retrain', help='Retrain the model every cycle', default='True')
    parser.add_argument('-batch_size', help='How many molecules we select each cycle', default=20)
    parser.add_argument('-anchored', help='Anchor the weights', default='True')
    parser.add_argument('-out', help='Path to save selected compounds', default='/home/jeremy/traversing_chem_space/data/Generic/out/')
   ...
   # PARAMETERS['retrain'] = [eval(args.retrain)]
    ...
    for experiment in tqdm(experiments):
       # print("it is" + str(experiments))
        ...
        results, compounds = active_learning_one_round(bias=experiment['bias'],
